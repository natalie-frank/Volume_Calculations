function [y] = components_proposal(x,k,m,A)
    ...
    x_move=maximum_move(x_disks,k,m,theta,A); %calculating the maximum distance disk k could travel before hitting another disk, (bounded above by some constant)
